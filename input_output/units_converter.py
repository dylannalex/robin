def convert_size_unit(n, size_unit):
    """
...
def convert_time_unit(n, time_unit):
    """
...
def convert_transfer_velocity(n, size_unit, time_unit):
    """
    ...
    return convert_size_unit(n, size_unit) * scale_factor
